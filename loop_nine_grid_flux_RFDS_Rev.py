...
def loop(cfg):
    ...
    for it in t_loop:
        ...
        # train_render4 = train_render[9:10, :, :, :]  # 提取后 4 张图片
        ...
        # )
        # with torch.no_grad():
        #     normalized_base_render = (base_render[9:10, :, :, :] - clip_mean[None, :, None, None]) / clip_std[None, :, None, None]
