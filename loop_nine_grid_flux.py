...
lora_weight = "/data/caiweiwei/kohya_ss/outputs/nine_mesh_grid1/"
        ...
        def call_dit(img, img_ids, t5_out, txt_ids, l_pooled, timesteps, guidance_vec, t5_attn_mask):
            ...
            with accelerator.autocast():
                ...
                model_pred = unet(  #jump flux_model.py Flux,class DoubleStreamBlock的forward()
                    img=img,  #shape = torch.Size([1, 1600, 64])
...
def loop(cfg):
    ...
    for it in t_loop:
        ...
        train_render4 = train_render[9:15, :, :, :]  # 提取后 4 张图片
        ...
        with torch.no_grad():
            normalized_base_render = (base_render[9:15, :, :, :] - clip_mean[None, :, None, None]) / clip_std[None, :, None, None]
