...
class VanillaDataset(Dataset):
    ...
    def __init__(
        ...
        instance_images_path = list(self.instance_data_root.glob("*.png"))
        instance_prompts_path = [path.with_suffix(".txt") for path in instance_images_path]
        
        instance_images = [Image.open(path) for path in instance_images_path]
        self.custom_instance_prompts = [self.read_caption(path, False) for path in instance_prompts_path]
    ...
    def read_caption(self, cap_path, enable_wildcard):
        if os.path.isfile(cap_path):
            ...
            raise ValueError("Instance Prompt root doesn't exists.")
        return caption
    ...
    def __getitem__(self, index):
        example = {}
        example["pixel_values"] = self.pixel_values[index]
        example["prompts"] = self.custom_instance_prompts[index]
